...
\begin{bsp}
	...
	\begin{center} 
			\begin{tikzpicture} 
					...
					\node (4) at (0,2) {$s_4$};
					\node (5)  at (0,0) {$s_5$};
					\draw[black!20!white] (-1,-1) grid (3,4);
					\draw (5) -- (1) -- (2) -- (3) -- (4) -- (5) -- (2) -- (4)  -- (1);
			\end{tikzpicture} 
	\end{center} 
	...
	\node (4) at (0,2) {$s_4$};
	\node (5)  at (0,0) {$s_5$};
	\draw[black!20!white] (-1,-2) grid (3,3);
	\draw (5) -- (1) -- (2) -- (3) -- (4) -- (5) -- (2) -- (4)  -- (1);
\end{tikzpicture}
\end{center}  
	Führen wir dagegen eine Spaltentransformation aus, so modifiziert sich in unserem Haus die Position eines der $5$ Punkte. Etwa man addieren des $2$fachen der dersten Spalte zur dritten Spalten ergibt sich die Matrix 
	\[
A= \begin{pmatrix} 
	2 & 2 & 5 & 0 & 0 \\ 
	0 & 2 & 3 & 2 & 0 
...
und das Bild 
	...
	\begin{tikzpicture} 
		...
		\node (4) at (0,2) {$s_4$};
		\node (5)  at (0,0) {$s_5$};
		\draw[black!20!white] (-1,-1) grid (6,4);
		\draw (5) -- (1) -- (2) -- (3) -- (4) -- (5) -- (2) -- (4)  -- (1);
	\end{tikzpicture} 
\end{center} 
